...
export async function POST(request) {
  ...
  try {
    var res = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({ model: 'claude-haiku-4-5', max_tokens: (mode === 'ielts_reading' || mode === 'toefl_reading' || mode === 'ielts_listening' || mode === 'toefl_listening') ? 1500 : 300, system: prompt, messages: messages })
    });
